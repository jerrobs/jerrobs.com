...
## 2. Strategy in Military and in Political Life
...
### 2.2 Carl von Clausewitz (1780 - 1831)
...
## 4. Strategy in Software Engineering
...
## 5. Strategy in Management Theory
...
#### 5.1.2 Three generic strategies
...
Complex goals and plans to achieve them usually need to be divided to be conquered - sometimes repeatedly. This results in a hierarchical structure. It is the top level of this structure that is usually called _strategy_, in military the level below is called _tactics_.

#### Temporal aspect

In terms of duration, the overall strategy is naturally more long-term than its components.


#### Complexity

The difficulty of problems inhabit the spectrum from simple, over complicated to complex/chaotic. Consider baking a cake, building a house or raising a child. A simple problem can be solved by following a recipe. A complicated task requires a project plan, which probably includes several recipes. Complex problems are notorious for unforeseen emergent surprises, in which case you are better served by a strategy.


#### Psychological aspect

Strategy is not just about making plans, but about influencing the minds of individuals and groups to achieve desired outcomes. This becomes even more important when the strategy is implemented not by one strategist alone, but by multiple agents.
